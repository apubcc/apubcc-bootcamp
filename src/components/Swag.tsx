...
const swags = [
	{
		name: "Swag 1",
		description: "Cup",
		imageUrl: "/cup.jpg", // Update the path to your image
	},
	{
		name: "Swag 2",
		description: "Lanyard",
		imageUrl: "/lanyard.jpg", // Update the path to your image
	},
	{
		name: "Swag 3",
		description: "Sticker 1",
		imageUrl: "/bubble.png", // Update the path to your image
	},
	{
		name: "Swag 4",
		description: "Sticker 2",
		imageUrl: "/games.png", // Update the path to your image
	},
	{
		name: "Swag 5",
		description: "Sticker 3",
		imageUrl: "/strive-to-lead.png", // Update the path to your image
	},
	{
		name: "Swag 4",
		description: "Participant Pass",
		imageUrl: "/pass.png", // Update the path to your image
	},
];
		...
		<>
			...
			<div className='flex justify-center items-center flex-wrap md:flex-wrap md:w-full'>
				{swags.map((item, index) => (
					...
					>
						<h3 className='text-lg font-bold text-white text-center mb-2'>{item.name}</h3>
